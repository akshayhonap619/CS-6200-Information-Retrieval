...
public class Task1_Lucene_Evaluator 
{
	static int qid=0;
	private static Analyzer analyzer = new StandardAnalyzer(Version.LUCENE_47);
	private static Analyzer sAnalyzer = new SimpleAnalyzer(Version.LUCENE_47);
	public static String outputpath = new File("Task1-Lucene").getAbsolutePath();
	...
	public static void main(String[] args) throws IOException, ParseException {
		...
		String basepath = new File("Index").getAbsolutePath()+"\\Task1LE";
	...
	//	while (!s.equalsIgnoreCase("q")) 
		{
			try {
				...
				s="";
				basepath="";
				basepath = new File("ProjectCorpus").getAbsolutePath();
				s = basepath;
		...
		e.evaluatePerformance(Results, new File("Task1_Lucene_Eval.csv"));
		}
	 ...
	 */
	Task1_Lucene_Evaluator(String indexDir) throws IOException {
