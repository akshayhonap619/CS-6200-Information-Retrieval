...
public class Task3B_Evaluator 
{
	static int qid=0;
	private static Analyzer analyzer = new StandardAnalyzer(Version.LUCENE_47);
	private static Analyzer sAnalyzer = new SimpleAnalyzer(Version.LUCENE_47);
	public static String outputpath = new File("Task3B_Results").getAbsolutePath();
	private IndexWriter writer;
	private ArrayList<File> queue = new ArrayList<File>();
	
	public static String basepath = new File("Index").getAbsolutePath()+"\\Task3BEv";
	...
	public static void main(String[] args) throws IOException, ParseException {
		...
		String filepath = new File("ProjectCorpus").getAbsolutePath();
	...
	//	while (!s.equalsIgnoreCase("q")) 
		{
			...
			//	.println("[Acceptable file types: .xml, .html, .html, .txt]");
				s="";
				basepath="";
				basepath = new File("StemmedCorpus").getAbsolutePath();
				s = basepath;
		...
		String kk = new File("").getAbsolutePath()+"\\cacm_stem.query.txt";
		BufferedReader b = new BufferedReader(new FileReader(new File(kk)));
		int i1=0;
	   	...
	   	while((buffer = b.readLine())!=null)
   	 {
	   		...
	   		i1++;
	   		query.put(String.valueOf(i1), buffer);
   	 }
	...
	e.evaluatePerformance(Results, new File("Task3B_Eval.csv"));
	 ...
	 */
	Task3B_Evaluator(String indexDir) throws IOException {
